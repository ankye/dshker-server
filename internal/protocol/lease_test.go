...
func TestLeaseGoldenUserNetworkAndTampering(t *testing.T) {
	...
	user, network, pair, attempt, first, second := strings.Repeat("1", 12), strings.Repeat("2", 12), strings.Repeat("3", 12), strings.Repeat("4", 12), strings.Repeat("5", 12), strings.Repeat("6", 12)
